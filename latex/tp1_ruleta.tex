...
\begin{figure}[H]
  \begin{mytikzresize}{0.8\textwidth}
    \centering
    \input{generated/tp1-frecuencia.tex}
...
\begin{figure}[H]
  \begin{mytikzresize}{0.8\textwidth}
    \centering
    \input{generated/tp1-promedio.tex}
...
\begin{figure}[H]
  \begin{mytikzresize}{0.8\textwidth}
    \centering
    \input{generated/tp1-desvio.tex}
...
\begin{figure}[H]
  \begin{mytikzresize}{0.8\textwidth}
    \centering
    \input{generated/tp1-varianza.tex}
...
\begin{figure}[H]
  \begin{mytikzresize}{0.8\textwidth}
    \centering
    \input{generated/tp1-frecuencia-multi.tex}
    \caption{frecuencia relativa para 10 corridas del experimento}
    \label{fig:tp1-frec-multi}
  \end{mytikzresize}
\end{figure}
...
\begin{figure}[H]
  \begin{mytikzresize}{0.8\textwidth}
    \centering
    \input{generated/tp1-promedio-multi.tex}
    \caption{valor promedio para 10 corridas del experimento}
    \label{fig:tp1-prom-multi}
  \end{mytikzresize}
\end{figure}
...
\begin{figure}[H]
  \begin{mytikzresize}{0.8\textwidth}
    \centering
    \input{generated/tp1-desvio-multi.tex}
    \caption{valor del desvío para 10 corridas del experimento}
    \label{fig:tp1-desvio-multi}
  \end{mytikzresize}
\end{figure}
...
\begin{figure}[H]
  \begin{mytikzresize}{0.8\textwidth}
    \centering
    \input{generated/tp1-varianza-multi.tex}
    \caption{valor de la varianza para 10 corridas del experimento}
    \label{fig:tp1-var-multi}
  \end{mytikzresize}
\end{figure}
